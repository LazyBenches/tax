 ...
 * @since 2.0
 *
 * @Entity(table="user_month_0", pool="settlement.pool")
 */
class UserMonth0
{
    /**
    ...
    /**
     * @param int $isPushedDetail
     *
     * @return void
     */
    public function setIsPushedDetail(int $isPushedDetail): void
    {
        $this->isPushedDetail = $isPushedDetail;
    }

    /**
     * @param int $isPushedSummary
     *
     * @return void
     */
    public function setIsPushedSummary(int $isPushedSummary): void
    {
        $this->isPushedSummary = $isPushedSummary;
    }
     ...
     * @return int
     */
    public function getIsPushedDetail(): ?int
    {
        return $this->isPushedDetail;
    }

    /**
     * @return int
     */
    public function getIsPushedSummary(): ?int
    {
        return $this->isPushedSummary;
    }
