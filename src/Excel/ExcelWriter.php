...
class ExcelWriter
{
    ...
    protected function initializeSheet($sheet_name, $col_widths=array(), $auto_filter=false, $freeze_rows=false, $freeze_columns=false )
    {
        ...
        $this->sheets[$sheet_name] = (object)array(
            ...
            'row_count' => 0,
            'file_writer' => new BufferWriter($sheet_filename),
            'columns' => array(),
            'merge_cells' => array(),
        ...
        $max_cell=ExcelWriter::xlsCell(self::EXCEL_2007_MAX_ROW, self::EXCEL_2007_MAX_COL);//XFE1048577
    ...
    protected function writeCell(BufferWriter &$file, $row_number, $column_number, $value, $num_format_type, $cell_style_idx)
    {
